        ...
        <div class="row">
          ...
          <div class="col-md-2 col-sm-6 pre-footer-col">
            ...
            <address class="margin-bottom-40">
              ...
              Fax: 300 323 1456<br>
              Email: <a href="mailto:info@metronic.com">example@gamil.com</a><br>
              Skype: <a href="skype:metronic"></a>
            </address>
          </div>
          <div class="col-md-3 col-sm-6 pre-footer-col">
            <a><img src="{{asset('assets/custom/playStore.png')}}"></a>
          </div>
          <div class="col-md-3 col-sm-6 pre-footer-col">
            <a><img src="{{asset('assets/custom/extension.png')}}"></a>
          </div>
          <!-- END BOTTOM CONTACTS -->
        </div>
        <hr>
